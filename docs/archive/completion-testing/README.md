# Historical shell completion testing
...
This directory contains historical completion test and development records.
The dated reports describe the implementation at the time they were written;
use the current [completion documentation](../../completion.md) for supported
behavior.
...
### For readers of this archive
The guides record the then-current installation and troubleshooting advice.
Start with [the current completion guide](../../completion.md) for supported
