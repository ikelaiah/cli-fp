...
small public API. v1.6.1 reserves version flags at every command scope, fixes
mixed-alias value ordering, and verifies the current guides with executable
Markdown recipes. The runtime remains class-based.
